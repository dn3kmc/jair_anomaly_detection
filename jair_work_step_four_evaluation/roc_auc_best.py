...
for f in listdir(mypath):
	if "ts_object" in f:
		...
		if ts.name in ["exchange-3_cpc_results_nofill.csv", "rds_cpu_utilization_cc0c53_filled.csv","FARM_filled.csv", "artificial_cd_1_nofill.csv"]:
			...
			if count % 4 == 3:
				...
				fig.savefig("ROCS_group_" + str(group) + ".eps", format="eps")
				# plt.show()
